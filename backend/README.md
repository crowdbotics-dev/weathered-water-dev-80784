...
## Project Structure
    ...
    ├── weathered_water_dev_80784  # Django project configurations
...
1. Clone this repo and `cd weathered_water_dev_80784`
...
2. Clone this repo and `cd weathered_water_dev_80784`
